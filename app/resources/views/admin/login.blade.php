            ...
            <div class="min-h-96 px-8 py-6 mt-4 text-left bg-white rounded-xl shadow-lg">
                <div class="flex flex-col justify-center items-center h-full select-none">
                    <div class="flex flex-col items-center justify-center gap-2 mb-8">
                        ...
                        <span class="m-0 text-xs max-w-[90%] text-center text-[#8B8E98]">Comece a usar nosso portal ADMIN, basta iniciar a seção e aproveitar a experiência.
                        </span>
                    </div>
                    <div class="w-full flex flex-col gap-2">
                        <label class="font-semibold text-xs text-gray-400 ">E-mail</label>
                        <input class="border rounded-lg px-3 py-2 mb-5 text-sm w-full outline-none"
                            placeholder="E-mail" />
                ...
                <div class="w-full flex flex-col gap-2">
                    ...
                    <input type="password" class="border rounded-lg px-3 py-2 mb-5 text-sm w-full outline-none"
                        placeholder="••••••••" />
